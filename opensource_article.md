...
Larger programs will typically derive from 
the [Window](http://arcade.academy/arcade.html#arcade.application.Window) class,
or use decorators. This allows a programmer to write code to handle drawing,
...
[pymunk_platformer.py](http://arcade.academy/examples/pymunk_platformer.htm)
